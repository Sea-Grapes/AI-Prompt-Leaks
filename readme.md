...
After using the prompt cracker you will likely want to transform the text back into a readable format. You can download and open `index.html` locally, which is also hosted at this link:  
