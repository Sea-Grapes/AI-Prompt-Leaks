...
This will be a compilation of random leaked internal AI prompts from random sources and websites. This repo is pretty much a backup in case other prompt leaks go down lol. Ngl, AI Prompts seem to just be gaslighting an LLM into doing something and praying it works.

Here is a prompt stealer stolen from [here](https://gist.github.com/lucasmrdt/4215e483257e1d81e44842eddb8cc1b3)
